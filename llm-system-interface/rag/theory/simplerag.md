...
docker-compose.yml starts ollama, chromadb, and rag-python, and the Python service only needs FastAPI plus HTTP client code.
===============================
...
docker compose up -d ollama chromadb rag-python llm-server
