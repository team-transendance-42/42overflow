...
MAJOR (2PT): Implement a complete RAG (P)
MAJOR (2PT): Implement a complete LLM system interface (P)
MINOR (1PT): Voice/speech integration for accessibility or interaction (P)
